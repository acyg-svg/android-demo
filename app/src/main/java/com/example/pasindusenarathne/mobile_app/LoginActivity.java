        ...
        signIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(check == true){
                    ...
                    Toast.makeText(getApplicationContext(),"您好！"+uname+"!",Toast.LENGTH_SHORT).show();
                    Toast.makeText(getApplicationContext(),"在这里开始出售商品吧！",Toast.LENGTH_SHORT).show();
                    userName.setText("");
                    password.setText("");
                    Intent intent = new Intent(LoginActivity.this, AddItems.class);
                    ...
                    Toast.makeText(getApplicationContext(),"登录账号密码错误或所填信息不完整；如您没有账号，可前往申请。",Toast.LENGTH_LONG).show();;
                }
            }
        });
